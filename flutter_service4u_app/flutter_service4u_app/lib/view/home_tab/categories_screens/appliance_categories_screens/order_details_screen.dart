            ...
            children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: getSvgImage("copy_icon.svg")
                                  .paddingSymmetric(
                                      horizontal: 14.06, vertical: 6.h),
                            )
                          ],
                        ).paddingAll(16.h),
                      ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    border: Border(
                                        bottom: BorderSide(color: greyButton))),
                                child: Row(
                                  mainAxisAlignment:
                              ...
                              getVerSpace(14.h),
                              getCustomFont(
                                  "Payment Method", 14.sp, Color(0XFF33383F), 1,
                                  fontWeight: FontWeight.w600),
                              getVerSpace(12.h),
              ...
              common_container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: getCustomButton("Invoce Bill", () {},
                          color: context.theme.primaryColor,
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(12.h),
                              border: Border.all(color: greyButton, width: 2.h),
